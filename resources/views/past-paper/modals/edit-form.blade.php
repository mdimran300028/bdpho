...
<div class="modal fade exampleModal" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('past-paper-update') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">

                    <div class="form-group row mb-3">
                        <label for="eventEdit" class="col-md-2 col-sm-3 text-right col-form-label"> Event</label>
                        <div class="col-md-10 col-sm-9">
                            <select class="form-control" name="event_id" id="eventEdit" required>
                    ...
                    <div class="form-group row mb-3">
                        <label for="roundEdit" class="col-md-2 col-sm-3 text-right col-form-label"> Round</label>
                        <div class="col-md-10 col-sm-9">
                            <select class="form-control" name="round_id" id="roundEdit" required>
                                <option value="">--Select--</option>
                    ...
                    <div class="form-group row mb-3">
                        <label for="categoryIdEdit" class="col-md-2 col-sm-3 text-right col-form-label"> Category</label>
                        <div class="col-md-10 col-sm-9">
                    ...
                    <div class="form-group row mb-0">
                        <label for="fileEdit" class="col-md-2 col-sm-3 text-right col-form-label"> File</label>
                        <div class="col-md-10 col-sm-9">
                            <input type="file" name="file" class="form-control" id="fileEdit"/>
                        </div>
                    </div>
