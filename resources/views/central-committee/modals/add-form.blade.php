...
<div class="modal fade exampleModal" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('central-member-add') }}" method="post" enctype="multipart/form-data">
                @csrf
...
{{--                    <div class="form-group row mb-3">--}}
{{--                        <label for="institute" class="col-md-2 col-sm-3 text-right col-form-label"> Institute</label>--}}
{{--                        <div class="col-md-10 col-sm-9">--}}
...
{{--                    <div class="form-group row mb-3">--}}
{{--                        <label for="department" class="col-md-2 col-sm-3 text-right col-form-label"> Department</label>--}}
{{--                        <div class="col-md-10 col-sm-9">--}}
