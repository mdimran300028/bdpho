    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="deposit"><i class="fa fa-edit"></i> Organizer Info Edit Form</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('central-member-update') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <textarea class="form-control summernote" name="description" id="descriptionEdit"></textarea>
                        </div>
                    </div>
...
{{--                    <div class="form-group row mb-3">--}}
{{--                        <label for="instituteEdit" class="col-md-2 col-sm-3 text-right col-form-label"> Institute</label>--}}
{{--                        <div class="col-md-10 col-sm-9">--}}
{{--                            <input type="text" name="institute" class="form-control" id="instituteEdit"/>--}}
{{--                        </div>--}}
{{--                    </div>--}}

{{--                    <div class="form-group row mb-3">--}}
{{--                        <label for="departmentEdit" class="col-md-2 col-sm-3 text-right col-form-label"> Department</label>--}}
{{--                        <div class="col-md-10 col-sm-9">--}}
{{--                            <input type="text" name="department" class="form-control" id="departmentEdit"/>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                    </div>--}}
                    ...
                    <div class="form-group row mb-3">
                        <label for="emailEdit" class="col-md-2 col-sm-3 text-right col-form-label"> Email</label>
                        <div class="col-md-10 col-sm-9">
