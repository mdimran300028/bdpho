    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="deposit"><i class="fa fa-edit"></i> Class Edit Form</h5>
            ...
            <form action="{{ route('class-update') }}" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group row mb-4">
                        <label for="editName" class="col-md-2 col-sm-3 col-form-label">Class Name</label>
                    ...
                    <div class="form-group row mb-4">
                        <label for="editCode" class="col-md-2 col-sm-3 col-form-label"><Class></Class> Code</label>
                        <div class="col-md-10 col-sm-9">
