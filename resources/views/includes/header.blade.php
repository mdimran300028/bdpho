...
{{--                        <img src="{{ asset('assets') }}/images/logo-light.svg" alt="" height="22">--}}
                        <img class="img-thumbnail" src="{{ asset('assets/images/bdpho/general/bdphologo_small.png')}}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
{{--                        <img src="{{ asset('assets') }}/images/logo-light.png" alt="" height="19">--}}
                        <img class="img-thumbnail" src="{{ asset('assets/images/bdpho/general/bdphologo.png')}}" alt="" height="19">
                    </span>
                </a>
            </div>
