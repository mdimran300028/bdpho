...
{{--                        <img src="{{ asset('assets') }}/images/logo-light.svg" alt="" height="22">--}}
                        @php($smallLogo = siteInfo('small_logo'))
                        <img class="img-thumbnail"
                             src="{{ isset($smallLogo)? asset($smallLogo) : asset('assets/images/bdpho/general/bdphologo_small.png')}}"
                             alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        @php($logo = siteInfo('logo'))
{{--                        <img src="{{ asset('assets') }}/images/logo-light.png" alt="" height="19">--}}
                        <img class="img-thumbnail bg-white"
                             src="{{ isset($logo)? asset($logo) : asset('assets/images/bdpho/general/bdphologo.png')}}"
                             alt="" height="19">
                    </span>
                </a>
            </div>
