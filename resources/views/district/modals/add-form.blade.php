    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="deposit"><i class="fa fa-edit"></i> District Add Form</h5>
            ...
            <form action="{{ route('district-add') }}" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group row mb-4">
                        <label for="divisionId" class="col-md-2 col-sm-3 col-form-label">Division Name</label>
                        <div class="col-md-10 col-sm-9">
                            <select name="division_id" class="form-control" id="divisionId">
                    ...
                    <div class="form-group row mb-4">
                        <label for="name" class="col-md-2 col-sm-3 col-form-label">District Name</label>
                        <div class="col-md-10 col-sm-9">
                    ...
                    <div class="form-group row mb-4">
                        <label for="code" class="col-md-2 col-sm-3 col-form-label">District Code</label>
                        <div class="col-md-10 col-sm-9">
