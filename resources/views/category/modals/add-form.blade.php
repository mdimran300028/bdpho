    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="deposit"><i class="fa fa-edit"></i> Category Add Form</h5>
            ...
            <form action="{{ route('category-add') }}" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group row mb-4">
                        <label for="name" class="col-md-2 col-sm-3 col-form-label">Category Name</label>
                    ...
                    <div class="form-group row mb-4">
                        <label for="code" class="col-md-2 col-sm-3 col-form-label">Category Code</label>
                        <div class="col-md-10 col-sm-9">
                    ...
                    <div class="form-group row mb-3">
                        <label for="classes" class="col-md-2 col-sm-3 col-form-label">Classes </label>
                        <div class="col-md-10 col-sm-9">
                            <select name="classes[]" class="select2 select2-multiple form-control" multiple="multiple" id="classes" style="width: 100%" data-placeholder="Choose. . . . .">
